...
class Mqtt_Publisher:
    def __init__(self, broker_ip='iot-06z00jl8tcjx5tf.mqtt.iothub.aliyuncs.com',
                 clientId="k0eudLzkYR8.stm32_mqtt_esp8266|securemode=2,signmethod=hmacsha256,timestamp=1699097409592|", port=1883,
                 username="stm32_mqtt_esp8266&k0eudLzkYR8", intopic="/sys/k0eudLzkYR8/stm32_mqtt_esp8266/thing/service/property/set",
